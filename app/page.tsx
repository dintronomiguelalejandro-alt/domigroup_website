      ...
      <main>
        <section className="border-b border-border/60">
          <div className="mx-auto max-w-6xl px-6 py-24 md:py-32">
            ...
            <div className="mt-20 flex flex-wrap gap-x-12 gap-y-6 border-t border-border/60 pt-8">
              {stats.map((stat) => (
                <div key={stat.label}>
        ...
        <section id="categories" className="border-b border-border/60">
          <div className="mx-auto max-w-6xl px-6 py-24">
            ...
            <p className="mt-14 text-xs font-medium tracking-widest text-muted-foreground uppercase">
          ...
          <div className="mx-auto max-w-6xl px-6 py-24">
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-3">
              {markets.map((market) => (
                <Card
                  key={market.name}
                  className="flex-row items-center gap-3 rounded-2xl border border-border/60 px-6 py-5 shadow-none"
                >
